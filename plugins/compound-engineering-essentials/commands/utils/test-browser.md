...
<requirements>
- Local development server running (e.g., `npm run dev`, `python manage.py runserver`)
...
Map changed files to testable routes based on your framework:

| File Pattern | Route(s) |
|-------------|----------|
| `src/pages/*` or `src/app/*` | Corresponding routes |
| `src/components/*` | Pages using those components |
| `src/views/*` or `templates/*` | Corresponding view routes |
| `src/layouts/*` or `layouts/*` | All pages (test homepage at minimum) |
| `src/styles/*` or `styles/*` | Visual regression on key pages |
| `api/*` or `routes/*` | API endpoints (test via UI that uses them) |

Build a list of URLs to test based on your project's routing structure.
...
Please start your development server (e.g., `npm run dev`, `yarn dev`, `python manage.py runserver`)
