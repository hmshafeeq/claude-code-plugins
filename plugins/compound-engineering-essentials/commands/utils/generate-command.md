...
**Integrations:**
- MCP servers - project-specific integrations
- External APIs - as needed for your workflow
...
4. Verify
   - Run tests: `npm test` (or your project's test command)
   - Run linter: `npm run lint` (or your project's lint command)
