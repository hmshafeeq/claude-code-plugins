...
- **component** (enum): One of [model, controller, view, service, background_job, database, frontend, ui_component, api_handler, auth, payment, development_workflow, testing, documentation, tooling, config]
