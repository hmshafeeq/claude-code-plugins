...
component: [model|controller|view|service|background_job|database|frontend|ui_component|api_handler|auth|payment]
symptoms:
...
- Affected Component: [e.g., "User model", "API handler", "Auth controller"]
